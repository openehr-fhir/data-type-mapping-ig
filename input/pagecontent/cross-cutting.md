...
| Compact time with a compact UTC offset <br/>*(`time`)* | `T143000+0100` | ✓ | — | SHALL be expanded to `14:30:00+01:00` before the offset is separated from the time; FHIR accepts neither the compact time nor the compact offset. |
